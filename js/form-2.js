...
{
    const current_step = $(event.currentTarget).closest('.sec-question');
    ...
    current_step.toggleClass('hidden').toggleClass('fadeIn');
    next_step.toggleClass('hidden').toggleClass('fadeIn');
